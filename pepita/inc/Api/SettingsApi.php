...
class SettingsApi
{
	...
	public function setSubPagesTitle(string $title = null){
		...
		if (empty($this->adminPages)) {
			...
			/* Hogyha egyedi nevet szeretnék a sub menü első elemének, akkor ezzel felül írhatjuk, hogy ne az alap elnevezés legyen. */
			...
			$subPages = array(
				...
				[
					...
					'menu_title' => (!empty($title)) ? $title : $adminPage["menu_title"],
